...
// import ic_reset_password from 'assets/icons/ic_reset_password.png';
      ...
      <View
        ...
        <View style={basicStyles.flexOne}>
          ...
          <View style={styles.infoContainer}>
            <TouchableOpacity
              style={[basicStyles.directionRow, styles.inputContainer]}
              ...
              <Image
                ...
                style={styles.icons}
              />
              <Text style={styles.info}>लॉगआउट करे</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
